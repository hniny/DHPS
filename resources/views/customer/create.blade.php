					 ...
					 <div class="row">
						...
						<div class="col-xs-3 col-sm-3 col-md-3">
							<div class="form-group">
								...
								<input type="email" name="email" class="form-control" placeholder="အီးမေးလ်လိပ်စာ">
							</div>
						</div>
						<div class="col-xs-3 col-sm-3 col-md-3">
							<div class="form-group">
           ...
           <div class="col-xs-12 col-sm-12 col-md-12">
             <div class="form-group">
               ...
               <textarea class="form-control" style="height:150px" name="delivery_address" placeholder="ပို့ရန်လိပ်စာထည့်ရန်" required></textarea>
						...
						<div class="col-xs-3 col-sm-3 col-md-3 ">
							<a class="btn btn-secondary" href="{{ route('customers.index') }}"> ပယ်ဖျက်သည်</a>
							<button type="submit" class="btn btn-primary">သိမ်းဆည်သည်</button>
						</div>
					</div>
				</form>
				</div>
