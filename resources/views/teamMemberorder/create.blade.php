  ...
  <div class="row py-2">
      <div class="col-md-12">
          <div class="card shadow-sm">
            ...
            @endif        
            <form action="{{ route('teammember_orders.store') }}" method="POST" class=" repeater needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                 <div class="row">
                     @if ($isTeamMember)
                 ...
                 <div class="row">
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="biller_address" id="" rows="3" required>{{$teammember[0]}}</textarea>
                        </div>
                    </div>
                    <div class="col-xs-6 col-sm-6 col-md-6">
                        <div class="form-group">
                            <strong><span class="text-danger">*</span>ပို့ရန်လိပ်စာ:</strong>
                            <textarea class="form-control" name="delivery_address" id="" rows="3" required>{{ $teammember[0]}}</textarea>
                        </div>
                    </div>
                            ...
                            <div data-repeater-item>
                                ...
                                <div class="row border rounded bg-light py-3 mb-2">
                                    ...
                                    <div class="col-6 col-md-3">
                                        ...
                                        <input type="number" name="quantity" class="form-control " placeholder="အရေအတွက်" required>
                                        <span class="text-secondary">
                                            ကျသင့်ငွေ
                                        </span>
