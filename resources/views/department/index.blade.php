            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="float-right">
                        @can('city-create')
                        <a class="btn btn-success btn-sm" href="{{ route('departments.create') }}">Create New</a>
                        @endcan
                    </div>
                </div>
                </div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="{{ route('departments.destroy',$department->id) }}" method="POST">
                            <a class="btn btn-info btn-sm" href="{{ route('departments.show',$department->id) }}"><i class="fa fa-eye"></i></a>
                            @can('department-edit')
                            <a class="btn btn-primary btn-sm" href="{{ route('departments.edit',$department->id) }}"><i class="fa fa-edit"></i></a>
                            @endcan
                            @csrf
                            @method('DELETE')
