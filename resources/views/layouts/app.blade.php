                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                          ...
                          <a href="/warehouse" class="nav-link text-white">အော်ဒါများ</a>
                        ...
                        @can('consigment-list')
                        <li class="nav-item">
                            <a href="/payment_terms" class="nav-link text-white">Payment Terms</a>
                        </li>
                        @endcan
                        <!-- @can('creditReturn-list')
                        <li class="nav-item">
                        ...
                        @can('department-list')
                        <li class="nav-item">
                            <a href="/departments" class="nav-link text-white">Departments</a>
                        </li>
                        @endcan
                        @can('position-list')
                        <li class="nav-item">
                            <a href="/positions" class="nav-link text-white">Positions</a>
                        </li>
                        @endcan
